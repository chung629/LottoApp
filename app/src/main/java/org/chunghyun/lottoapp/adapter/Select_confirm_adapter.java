...
public class Select_confirm_adapter extends RecyclerView.Adapter<Select_confirm_adapter.ViewHolder>{
    ...
    ArrayList<Lotto_Select_MyEntity> items = new ArrayList<>();
    Context context;
    ...
    public Select_confirm_adapter(MyDatabase db, Context context, String round, ArrayList<String> numbers, String bonus){
        this.db = db;
    ...
    @NonNull
    @Override
    public Select_confirm_adapter.ViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        View view = LayoutInflater.from(parent.getContext()).inflate(R.layout.item_input_confirm, parent, false);
        return new ViewHolder(view);
    }
    @Override
    public void onBindViewHolder(@NonNull Select_confirm_adapter.ViewHolder holder, int position) {
        ...
        holder.linearLayout.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                Select_Dialog select_dialog = new Select_Dialog(context, items.get(position));
                select_dialog.show();
            }
        });
    }
    ...
    public void editData(int index, String result){
        new Thread(()->{
            ...
            db.selectDao().update(items.get(index));
        }).start();
    }

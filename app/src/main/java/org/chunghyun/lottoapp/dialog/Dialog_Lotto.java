...
public class Dialog_Lotto extends Dialog {
    ...
    public Dialog_Lotto(@NonNull Context context) {
        super(context);
        this.context = context;
    }
    //리스너 초기화
    public void setDialogListener(Dialog_Lotto.DialogClickListener dialogListener){
    ...
    public void init(){
                ...
                public void onClick(View v) {
                    ...
                    if(isClick[temp]) {
                        if(selectNumber.size() < 6){
                            ...
                            Toast.makeText(getContext(), "6개의 숫자만 선택 가능 합니다", Toast.LENGTH_SHORT).show();
                        }
                    } else{
        ...
        yes.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                if(selectNumber.size() != 6){
                    Toast.makeText(getContext(), "숫자 6개를 선택해주세요", Toast.LENGTH_SHORT).show();
                }else{

...
@Entity(tableName = "lotto_Occur_database")
public class Lotto_Occur_MyEntity {
    ...
    public Lotto_Occur_MyEntity(String round, String num1, String num2, String num3, String num4, String num5, String num6, String result){
        this.round = round;
        this.num1 = num1;
        this.num2 = num2;
        this.num3 = num3;
